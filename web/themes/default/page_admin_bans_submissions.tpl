                    ...
                    <details class="queue-row ban-row ban-row--active"
                        ...
                        <div class="p-4" style="background:var(--bg-muted);border-top:1px solid var(--border)">
                            ...
                            <form hidden class="mt-4" data-comment-composer data-bid="{$sub.subid}" data-ctype="S" data-testid="queue-comment-form">
                              ...
                              <label class="label" for="queue-comment-text-s{$sub.subid}">Comment</label>
                              <textarea class="textarea" name="ctext" id="queue-comment-text-s{$sub.subid}" rows="4" aria-required="true"></textarea>
