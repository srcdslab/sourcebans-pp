                ...
                {foreach from=$protest_list_archiv item="protest"}
                    ...
                    <details class="queue-row ban-row ban-row--expired"
                        ...
                        <div class="p-4" id="ban_details_{$protest.pid}" style="background:var(--bg-muted);border-top:1px solid var(--border)">
                                                ...
                                                <div class="flex items-center justify-between gap-2 text-xs text-muted mb-2">
                                                    ...
                                                    <span class="flex items-center gap-2">
                                                        ...
                                                        {if $commenta.editcomlink != ""}
                                                            {* nofilter: editcomlink/delcomlink are server-built buttons/anchors with integer cid + pid; comment text on edit is htmlspecialchars'd into data-comment-text. *}
                            ...
                            {/if}
                            <form hidden class="mt-4" data-comment-composer data-bid="{$protest.pid}" data-ctype="P" data-testid="queue-comment-form">
                              <input type="hidden" name="cid" value="">
                              <label class="label" for="queue-comment-text-pa{$protest.pid}">Comment</label>
                              <textarea class="textarea" name="ctext" id="queue-comment-text-pa{$protest.pid}" rows="4" aria-required="true"></textarea>
