...
final class RestPermissionMatrixTest extends TestCase
{
    ...
    public static function expectedRoutes(): array
    {
        ...
        return [
            ...
            ['method' => 'POST', 'path' => '/protests/{pid}/archive', 'auth' => true, 'perm' => $protests],
            ['method' => 'POST', 'path' => '/protests/{pid}/restore', 'auth' => true, 'perm' => $protests],
            ...
            ['method' => 'POST', 'path' => '/submissions/{sid}/archive', 'auth' => true, 'perm' => $submissions],
            ['method' => 'POST', 'path' => '/submissions/{sid}/restore', 'auth' => true, 'perm' => $submissions],
